          ...
          <div class="col-lg-10 vh-100">
            <div class='card mt-4'>
              <div class='card-header'>
                <a name="" id="" class="btn btn-dark" href="/user/formUser" role="button"><i class="bi bi-plus-square"></i> <b>Create</b></a>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$usr -> nama_user}}</td>
                      <td>{{$usr -> no_hp}}</td>
                      <td><a href="/user/updateUser/{{$usr->id}}" class="btn btn-outline-dark"><i class="bi bi-pencil-square"></i></a>
                      <button onclick="handleDelete({{$usr->id}})" class="btn btn-outline-danger"><i class="bi bi-x-square"></i></button></td>
                    </tr>
                    @endforeach
                  </tbody>
                </table>
