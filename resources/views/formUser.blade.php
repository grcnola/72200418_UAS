                  ...
                  <div class="container-fluid mt-4 rounded background-color-$green-200">
                    <form action="/user/saveUser" method="POST" class="pt-2 pb-2">
                        ...
                        <div class="form-group w-25">
                            <label><b>NIK</b></label>
                            <input type="number" name="nik_user" class="form-control" placeholder="Masukkan NIK">
                        </div>
                        <div class="form-group w-25">
                        ...
                        <div class="form-group w-25">
                            ...
                            <input type="number" name="no_hp" class="form-control" placeholder="Masukkan no kontak">
                        </div>
                        <div class="form-group w-25">
