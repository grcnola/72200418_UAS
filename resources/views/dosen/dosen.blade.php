          ...
          <div class="col-lg-10 vh-100">
            <div class='card mt-4'>
              ...
              <div class='card-header'>
                <a name="" id="" class="btn btn-dark" href="/dosen/dosen/formDosen" role="button"><i class="bi bi-plus-square"></i> <b>Create</b></a>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$ds -> no_hp}}</td>
                      <td>{{$ds -> email}}</td>
                      <td><a href="/dosen/dosen/updateDosen/{{$ds->id}}" class="btn btn-outline-dark"><i class="bi bi-pencil-square"></i></a>
                      <button onclick="handleDelete({{$ds->id}})" class="btn btn-outline-danger"><i class="bi bi-x-square"></i></button></td>
                    </tr>
                    @endforeach
                  </tbody>
                </table>
